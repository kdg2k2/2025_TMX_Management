const createPagination = (data, type, onPageChange) => {
    const paginationId = type === 'original' ? 'pagination-original' : 'pagination-selected';
    ...
    for (let i = 1; i <= data.last_page; i++) {
        if (i === 1 || i === data.last_page || (i >= data.current_page - 1 && i <= data.current_page + 1)) {
            ...
            dotsLi.innerHTML = '<a class="page-link" href="javascript:void(0);"><i class="bi bi-three-dots"></i></a>';
