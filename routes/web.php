...
use App\Http\Controllers\Admin\ContractPersonnelController;
...
Route::middleware(['isLogin', 'LogAccess'])->group(function () {
    ...
    Route::prefix('contract')->group(function () {
        ...
        Route::prefix('personnel')->controller(ContractPersonnelController::class)->group(function () {
            Route::get('index', 'index')->name('contract.personnel.index');
            Route::get('export', 'export')->name('contract.personnel.export');
            Route::put('import', 'import')->name('contract.personnel.import');
        });
    });
    ...
    Route::prefix('kaspersky')->group(function () {
        ...
        Route::prefix('registration')->controller(KasperskyCodeRegistrationController::class)->group(function () {
            Route::get('index', 'index')->name('kaspersky.registration.index');
            Route::get('create', 'create')->name('kaspersky.registration.create');
            Route::post('approve', 'approve')->name('kaspersky.registration.approve');
