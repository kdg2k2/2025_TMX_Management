<div class="card">
    ...
    <div class="card-body">
        <form class="row" id="orther-file-form" action="{{ route('api.bidding.orther-file.store') }}"
            ...
            <div class="col-12 row" id="orther-file-clone-row">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="my-1">
                        ...
                        <input type="file" class="form-control" name="orther_file[0][path]" accept=".pdf,.docx,.xlsx"
                            required>
                    </div>
                </div>
            ...
            <div class="my-1 col-12 text-center btn-submit-row">
                <x-button-submit />
            </div>
        </form>
    </div>
