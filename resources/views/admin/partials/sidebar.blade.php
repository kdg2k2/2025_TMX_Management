    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="index1" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="index2" class="side-menu__item">Dashboard</a>
                                </li>
                                <li class="slide">
                                    <a href="products" class="side-menu__item">Products</a>
                                </li>
                                <li class="slide">
                                    <a href="product-details" class="side-menu__item">Product Details</a>
                                </li>
                                <li class="slide">
                                    <a href="cart" class="side-menu__item">Cart</a>
                                </li>
                                <li class="slide">
                                    <a href="checkout" class="side-menu__item">Checkout</a>
                                </li>
                                <li class="slide">
                                    <a href="customers-list" class="side-menu__item">Customers</a>
                                </li>
                                <li class="slide">
                                    <a href="orders" class="side-menu__item">Orders</a>
                                </li>
                                <li class="slide">
                                    <a href="orders-details" class="side-menu__item">Order Details</a>
                                </li>
                                <li class="slide">
                                    <a href="add-product" class="side-menu__item">Add Product</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="index4" class="side-menu__item">Dashboard</a>
                                </li>
                                <li class="slide">
                                    <a href="crypto-transactions" class="side-menu__item">Transactions</a>
                                </li>
                                <li class="slide">
                                    <a href="crypto-currency-exchange" class="side-menu__item">Exchange</a>
                                </li>
                                <li class="slide">
                                    <a href="crypto-buy_sell" class="side-menu__item">Buy & Sell</a>
                                </li>
                                <li class="slide">
                                    <a href="crypto-marketcap" class="side-menu__item">Marketcap</a>
                                </li>
                                <li class="slide">
                                    <a href="crypto-wallet" class="side-menu__item">Wallet</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="index3" class="side-menu__item">Dashboard</a>
                                </li>
                                <li class="slide">
                                    <a href="crm-contacts" class="side-menu__item">Contacts</a>
                                </li>
                                <li class="slide">
                                    <a href="crm-companies" class="side-menu__item">Companies</a>
                                </li>
                                <li class="slide">
                                    <a href="crm-deals" class="side-menu__item">Deals</a>
                                </li>
                                <li class="slide">
                                    <a href="crm-leads" class="side-menu__item">Leads</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="index6" class="side-menu__item">Dashboard</a>
                                </li>
                                <li class="slide">
                                    <a href="projects-list" class="side-menu__item">Projects List</a>
                                </li>
                                <li class="slide">
                                    <a href="projects-overview" class="side-menu__item">Project Overview</a>
                                </li>
                                <li class="slide">
                                    <a href="projects-create" class="side-menu__item">Create Project</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a href="index8" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
                        ...
                        <li class="slide">
                            <a href="index9" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="index10" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="index5" class="side-menu__item">Dashboard</a>
                                </li>
                                <li class="slide">
                                    <a href="nft-marketplace" class="side-menu__item">Market Place</a>
                                </li>
                                <li class="slide">
                                    <a href="nft-details" class="side-menu__item">NFT Details</a>
                                </li>
                                <li class="slide">
                                    <a href="nft-create" class="side-menu__item">Create NFT</a>
                                </li>
                                <li class="slide">
                                    <a href="nft-wallet-integration" class="side-menu__item">Wallet Integration</a>
                                </li>
                                <li class="slide">
                                    <a href="nft-live-auction" class="side-menu__item">Live Auction</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    ...
                                    <path
                                        ...
                                        opacity="0.2" />
                                    <line x1="112" y1="112" x2="144" y2="112"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="index7" class="side-menu__item">Dashboard</a>
                                </li>
                                <li class="slide">
                                    <a href="job-details" class="side-menu__item">Job Details</a>
                                </li>
                                <li class="slide">
                                    <a href="job-company-search" class="side-menu__item">Search Company</a>
                                </li>
                                <li class="slide">
                                    <a href="job-search" class="side-menu__item">Search Jobs</a>
                                </li>
                                <li class="slide">
                                    <a href="job-post" class="side-menu__item">Job Post</a>
                                </li>
                                <li class="slide">
                                    <a href="jobs-list" class="side-menu__item">Jobs List</a>
                                </li>
                                <li class="slide">
                                    <a href="job-candidate-search" class="side-menu__item">Search Candidate</a>
                                </li>
                                <li class="slide">
                                    <a href="job-candidate-details" class="side-menu__item">Candidate Details</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a href="index13" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="index15" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <path d="M92.1,176A72,72,0,0,0,160,224h64a8,8,0,0,0,8-8V152a72,72,0,0,0-68.06-71.89"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                </svg>
                                Social Media</a>
                        ...
                        <li class="slide">
                            <a href="index14" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="index11" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="index12" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    ...
                                    <polyline points="184 88 128 24 72 88" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
                                    <line x1="180.8" y1="120" x2="175.2" y2="176"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="75.2" y1="120" x2="80.8" y2="176"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <path d="M24,88H232L216.93,201.06A8,8,0,0,1,209,208H47a8,8,0,0,1-7.93-6.94Z"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="mail" class="side-menu__item">Mail App</a>
                                </li>
                                <li class="slide">
                                    <a href="mail-settings" class="side-menu__item">Mail Settings</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide">
                            <a href="full-calendar" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="sweet_alerts" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="task-kanban-board" class="side-menu__item">Kanban Board</a>
                                </li>
                                <li class="slide">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1 pages-ul">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    ...
                                    <path
                                        ...
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="128" y1="232" x2="128" y2="48"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="40.86" y1="128" x2="215.14" y2="128"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                </svg>
                                Authentication
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="coming-soon" class="side-menu__item">Coming Soon</a>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="create-password-basic" class="side-menu__item">Basic</a>
                                        </li>
                                        <li class="slide">
                                            <a href="create-password-cover" class="side-menu__item">Cover</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="lockscreen-basic" class="side-menu__item">Basic</a>
                                        </li>
                                        <li class="slide">
                                            <a href="lockscreen-cover" class="side-menu__item">Cover</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="reset-password-basic" class="side-menu__item">Basic</a>
                                        </li>
                                        <li class="slide">
                                            <a href="reset-password-cover" class="side-menu__item">Cover</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="sign-up-basic" class="side-menu__item">Basic</a>
                                        </li>
                                        <li class="slide">
                                            <a href="sign-up-cover" class="side-menu__item">Cover</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="sign-in-basic" class="side-menu__item">Basic</a>
                                        </li>
                                        <li class="slide">
                                            <a href="sign-in-cover" class="side-menu__item">Cover</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="two-step-verification-basic" class="side-menu__item">Basic</a>
                                        </li>
                                        <li class="slide">
                                            <a href="two-step-verification-cover" class="side-menu__item">Cover</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide">
                                    <a href="under-maintenance" class="side-menu__item">Under Maintenance</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="401-error" class="side-menu__item">401 - Error</a>
                                </li>
                                <li class="slide">
                                    <a href="404-error" class="side-menu__item">404 - Error</a>
                                </li>
                                <li class="slide">
                                    <a href="500-error" class="side-menu__item">500 - Error</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="blog" class="side-menu__item">Blog</a>
                                </li>
                                <li class="slide">
                                    <a href="blog-details" class="side-menu__item">Blog Details</a>
                                </li>
                                <li class="slide">
                                    <a href="blog-create" class="side-menu__item">Create Blog</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a href="empty" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    ...
                                    <circle cx="128" cy="128" r="88" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="16" />
                                    <line x1="208" y1="40" x2="48" y2="216"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                </svg>
                                Empty</a>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="form_advanced" class="side-menu__item">Form Advanced</a>
                                </li>
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child3">
                                        <li class="slide">
                                            <a href="form_inputs" class="side-menu__item">Inputs</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_check_radios" class="side-menu__item">Checks & Radios</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_input_group" class="side-menu__item">Input Group</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_select" class="side-menu__item">Form Select</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_range" class="side-menu__item">Range Slider</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_input_masks" class="side-menu__item">Input Masks</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_file_uploads" class="side-menu__item">File Uploads</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_dateTime_pickers" class="side-menu__item">Date,Time
                                                Picker</a>
                                        </li>
                                        <li class="slide">
                                            <a href="form_color_pickers" class="side-menu__item">Color Pickers</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="slide">
                                    <a href="floating_labels" class="side-menu__item">Floating Labels</a>
                                </li>
                                <li class="slide">
                                    <a href="form_layout" class="side-menu__item">Form Layouts</a>
                                </li>
                                <li class="slide">
                                    <a href="form_wizards" class="side-menu__item">Form Wizards</a>
                                </li>
                                <li class="slide">
                                    <a href="quill_editor" class="side-menu__item">Quill Editor</a>
                                </li>
                                <li class="slide">
                                    <a href="form_validation" class="side-menu__item">Validation</a>
                                </li>
                                <li class="slide">
                                    <a href="form_select2" class="side-menu__item">Select2</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    ...
                                    <line x1="48" y1="48" x2="48" y2="56"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="48" y1="120" x2="48" y2="128"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <path d="M96,56H224V192a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V152" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="16" />
                                    <line x1="104" y1="104" x2="224" y2="104"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="80" y1="152" x2="224" y2="152"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="168" y1="104" x2="168" y2="200"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                </svg>
                                Invoice
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="invoice-create" class="side-menu__item">Create Invoice</a>
                                </li>
                                <li class="slide">
                                    <a href="invoice-details" class="side-menu__item">Invoice Details</a>
                                </li>
                                <li class="slide">
                                    <a href="invoice-list" class="side-menu__item">Invoice List</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a href="landing" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
                        ...
                        <li class="slide">
                            <a href="profile-settings" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
                                    ...
                                    <line x1="200" y1="40" x2="200" y2="28"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <circle cx="200" cy="56" r="16" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="16" />
                                    <line x1="186.14" y1="48" x2="175.75" y2="42"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="186.14" y1="64" x2="175.75" y2="70"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="200" y1="72" x2="200" y2="84"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="213.86" y1="64" x2="224.25" y2="70"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="213.86" y1="48" x2="224.25" y2="42"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <circle cx="128" cy="120" r="40" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li class="slide">
                            <a href="search-results" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="terms_conditions" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <polygon points="152 32 152 88 208 88 152 32" opacity="0.2" />
                        ...
                        <li class="slide">
                            <a href="timeline" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    ...
                                    <line x1="40" y1="64" x2="216" y2="64"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="40" y1="128" x2="136" y2="128"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="40" y1="192" x2="136" y2="192"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="alerts" class="side-menu__item">Alerts</a>
                                </li>
                                <li class="slide">
                                    <a href="badge" class="side-menu__item">Badge</a>
                                </li>
                                <li class="slide">
                                    <a href="breadcrumb" class="side-menu__item">Breadcrumb</a>
                                </li>
                                <li class="slide">
                                    <a href="buttons" class="side-menu__item">Buttons</a>
                                </li>
                                <li class="slide">
                                    <a href="buttongroup" class="side-menu__item">Button Group</a>
                                </li>
                                <li class="slide">
                                    <a href="cards" class="side-menu__item">Cards</a>
                                </li>
                                <li class="slide">
                                    <a href="dropdowns" class="side-menu__item">Dropdowns</a>
                                </li>
                                <li class="slide">
                                    <a href="images_figures" class="side-menu__item">Images & Figures</a>
                                </li>
                                <li class="slide">
                                    <a href="links_interactions" class="side-menu__item">Links & Interactions</a>
                                </li>
                                <li class="slide">
                                    <a href="listgroup" class="side-menu__item">List Group</a>
                                </li>
                                <li class="slide">
                                    <a href="navs_tabs" class="side-menu__item">Navs & Tabs</a>
                                </li>
                                <li class="slide">
                                    <a href="object-fit" class="side-menu__item">Object Fit</a>
                                </li>
                                <li class="slide">
                                    <a href="pagination" class="side-menu__item">Pagination</a>
                                </li>
                                <li class="slide">
                                    <a href="popovers" class="side-menu__item">Popovers</a>
                                </li>
                                <li class="slide">
                                    <a href="progress" class="side-menu__item">Progress</a>
                                </li>
                                <li class="slide">
                                    <a href="spinners" class="side-menu__item">Spinners</a>
                                </li>
                                <li class="slide">
                                    <a href="toasts" class="side-menu__item">Toasts</a>
                                </li>
                                <li class="slide">
                                    <a href="tooltips" class="side-menu__item">Tooltips</a>
                                </li>
                                <li class="slide">
                                    <a href="typography" class="side-menu__item">Typography</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="avatars" class="side-menu__item">Avatars</a>
                                </li>
                                <li class="slide">
                                    <a href="borders" class="side-menu__item">Borders</a>
                                </li>
                                <li class="slide">
                                    <a href="breakpoints" class="side-menu__item">Breakpoints</a>
                                </li>
                                <li class="slide">
                                    <a href="colors" class="side-menu__item">Colors</a>
                                </li>
                                <li class="slide">
                                    <a href="columns" class="side-menu__item">Columns</a>
                                </li>
                                <li class="slide">
                                    <a href="css_grid" class="side-menu__item">Css Grid</a>
                                </li>
                                <li class="slide">
                                    <a href="flex" class="side-menu__item">Flex</a>
                                </li>
                                <li class="slide">
                                    <a href="gutters" class="side-menu__item">Gutters</a>
                                </li>
                                <li class="slide">
                                    <a href="helpers" class="side-menu__item">Helpers</a>
                                </li>
                                <li class="slide">
                                    <a href="position" class="side-menu__item">Position</a>
                                </li>
                                <li class="slide">
                                    <a href="more" class="side-menu__item">Additional Content</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="accordions_collpase" class="side-menu__item">Accordions & Collapse</a>
                                </li>
                                <li class="slide">
                                    <a href="carousel" class="side-menu__item">Carousel</a>
                                </li>
                                <li class="slide">
                                    <a href="draggable-cards" class="side-menu__item">Draggable Cards</a>
                                </li>
                                <li class="slide">
                                    <a href="media-player" class="side-menu__item">Media Player</a>
                                </li>
                                <li class="slide">
                                    <a href="modals_closes" class="side-menu__item">Modals & Closes</a>
                                </li>
                                <li class="slide">
                                    <a href="navbar" class="side-menu__item">Navbar</a>
                                </li>
                                <li class="slide">
                                    <a href="offcanvas" class="side-menu__item">Offcanvas</a>
                                </li>
                                <li class="slide">
                                    <a href="placeholders" class="side-menu__item">Placeholders</a>
                                </li>
                                <li class="slide">
                                    <a href="ratings" class="side-menu__item">Ratings</a>
                                </li>
                                <li class="slide">
                                    <a href="ribbons" class="side-menu__item">Ribbons</a>
                                </li>
                                <li class="slide">
                                    <a href="scrollspy" class="side-menu__item">Scrollspy</a>
                                </li>
                                <li class="slide">
                                    <a href="sortable-list" class="side-menu__item">Sortable JS</a>
                                </li>
                                <li class="slide">
                                    <a href="swiperjs" class="side-menu__item">Swiper JS</a>
                                </li>
                                <li class="slide">
                                    <a href="tour" class="side-menu__item">Tour</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="widgets" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 256 256">
                            <rect width="256" height="256" fill="none" />
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="vector-maps" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="leaflet-maps" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
                        ...
                        <li class="slide">
                            <a href="google-maps" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <circle cx="128" cy="128" r="88" opacity="0.2" />
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="icons" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 256 256">
                            <rect width="256" height="256" fill="none" />
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="apex-line-charts" class="side-menu__item">Line Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-area-charts" class="side-menu__item">Area Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-column-charts" class="side-menu__item">Column Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-bar-charts" class="side-menu__item">Bar Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-mixed-charts" class="side-menu__item">Mixed Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-rangearea-charts" class="side-menu__item">Range Area Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-timeline-charts" class="side-menu__item">Timeline Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-funnel-charts" class="side-menu__item">Funnel Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-candlestick-charts" class="side-menu__item">CandleStick
                                        Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-boxplot-charts" class="side-menu__item">Boxplot Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-bubble-charts" class="side-menu__item">Bubble Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-scatter-charts" class="side-menu__item">Scatter Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-heatmap-charts" class="side-menu__item">Heatmap Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-treemap-charts" class="side-menu__item">Treemap Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-pie-charts" class="side-menu__item">Pie Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-radialbar-charts" class="side-menu__item">Radialbar Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-radar-charts" class="side-menu__item">Radar Charts</a>
                                </li>
                                <li class="slide">
                                    <a href="apex-polararea-charts" class="side-menu__item">Polararea Charts</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a href="chartjs-charts" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    ...
                                    <line x1="128" y1="128" x2="128" y2="32"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="211.14" y1="80" x2="44.86" y2="176"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                </svg>
                                Chartjs Charts
                        ...
                        <li class="slide">
                            <a href="echarts" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    ...
                                    <path d="M44.85,80A96,96,0,1,0,128,32V88a40,40,0,1,1-34.65,20Z" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="16" />
                                    <line x1="89.35" y1="138.36" x2="35.25" y2="152.85"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                </svg>
                                Echart Charts
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="tables" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                        ...
                        <li class="slide">
                            <a href="grid-tables" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    ...
                                    <rect x="32" y="56" width="192" height="144" rx="8"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="96" y1="56" x2="96" y2="200"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                                    <line x1="160" y1="56" x2="160" y2="200"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="16" />
                        ...
                        <li class="slide">
                            <a href="data-tables" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon"
                                    viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <path
            ...
            <ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="sign-in-cover" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 256 256">
                            <rect width="256" height="256" fill="none" />
                            <path
                ...
                <!-- Start::slide -->
                <li class="slide">
                    <a href="profile" class="side-menu__item p-1 rounded-circle mb-0">
