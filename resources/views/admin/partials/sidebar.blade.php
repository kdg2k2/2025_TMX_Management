                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="{{ route('device.index') }}" class="side-menu__item">
                                        <i
                                ...
                                <li class="slide">
                                    <a href="{{ route('device.loan.index') }}" class="side-menu__item">
                                        <i
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="{{ route('vehicle.index') }}" class="side-menu__item">
                                ...
                                <li class="slide">
                                    <a href="{{ route('vehicle.statistic.index') }}" class="side-menu__item">
                                        <i
