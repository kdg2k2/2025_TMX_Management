...
class ProfessionalRecordHandoverRepository extends BaseRepository
{
    public function __construct()
    {
        $this->model = new ProfessionalRecordHandover();
        $this->relations = [
            'minutes',
            'plan' => function ($q) {
                $q->with([
    ...
    {
        return $this->model->where('professional_record_plan_id', $id)->delete();
    }
