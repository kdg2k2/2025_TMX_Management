...
class VehicleLoan extends Model
{
    ...
    public function fuelCostPaidBy(){
        return $this->belongsTo(User::class, 'fuel_cost_paid_by');
    }

    public function maintenanceCostPaidBy(){
        return $this->belongsTo(User::class, 'maintenance_cost_paid_by');
    }
}
