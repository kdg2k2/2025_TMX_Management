...
class ProfessionalRecordPlan extends Model
{
    protected $guarded = [];
    ...
    {
        return $this->hasMany(ProfessionalRecordHandover::class);
    }
    ...
    {
        return $this->hasMany(ProfessionalRecordUsageRegister::class);
    }
}
