...
use App\Repositories\EmploymentContractPersonnelCustomFieldRepository;

class EmploymentContractPersonnelCustomFieldService extends BaseService
{
    public function __construct()
    {
        $this->repository = app(EmploymentContractPersonnelCustomFieldRepository::class);
    }
