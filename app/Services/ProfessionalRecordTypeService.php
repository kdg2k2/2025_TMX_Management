...
use App\Repositories\ProfessionalRecordTypeRepository;

class ProfessionalRecordTypeService extends BaseService
{
    public function __construct()
    {
        $this->repository = app(ProfessionalRecordTypeRepository::class);
    }
    ...
    public function export()
    {
        return $this->tryThrow(function () {
            ...
            return asset(app(ProfessionalRecordService::class)->createExcel(
                'uploads/professional-record/type',
                'professional_record_type_' . date('d-m-Y_H-i-s') . '.xlsx',
                $sheets
            ));
        });
    }
