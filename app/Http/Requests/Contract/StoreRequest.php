...
class StoreRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'instructor_ids.*' => 'nullable|exists:users,id',
            ...
            'contract_scopes' => 'nullable|array',
            'contract_scopes.*' => 'exists:provinces,code',
            'professional_ids' => 'nullable|array',
            'professional_ids.*' => 'nullable|exists:users,id',
            'disbursement_ids' => 'nullable|array',
            'disbursement_ids.*' => 'nullable|exists:users,id',
            'intermediate_collaborator_ids' => 'nullable|array',
            'intermediate_collaborator_ids.*' => 'nullable|exists:users,id',
        ];
    }
}
